...
//creates html div card for each results
		...
		function result(currentValue, index) {
			...
			index++;
			item.innerHTML ="<button class='sprk-c-Accordion__summary' data-id='accordion-item-"+index+"' data-analytics='analytics_string_goes_here' data-sprk-toggle='trigger' data-sprk-toggle-type='accordion' aria-controls='sprk_toggle_content_"+index+"' aria-expanded='false' style='pointer-events: auto;'><h3 class='sprk-c-Accordion__heading sprk-b-TypeDisplaySeven'>"+currentValue.fname+" "+currentValue.lname+"</h3><svg class='sprk-c-Icon sprk-c-Icon--toggle sprk-c-Accordion__icon sprk-c-Icon--xl' data-sprk-toggle='icon' viewBox='0 0 64 64'><use xlink:href='#chevron-down-circle' data-sprk-toggle='accordionIconUseElement'></use></svg></button><div data-sprk-toggle='content' id='sprk_toggle_content_"+index+"' style='display: block;' aria-hidden='true' class='DOM-slider-hidden'><div class='sprk-c-Accordion__content sprk-o-Stack sprk-o-Stack--medium'><p><a href='https://drive.rockfin.com/LeaderGoal?TeamMemberCommonId="+currentValue.username+"&viewType=AllGoals' target='_blank'>DRIVE</a></li></p></div></div></li>";
